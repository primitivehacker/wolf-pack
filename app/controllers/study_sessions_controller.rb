  ...
  def create
    ...
    respond_to do |format|
      if @study_session.save
        format.html { redirect_to root_url, notice: 'study_session was successfully created.' }
      else
  ...
  def update
    respond_to do |format|
      if @study_session.update(study_session_params)
        format.html { redirect_to root_url, notice: 'study_session was successfully updated.' }
      else
  ...
  def add_user
    ...
    respond_to do |format|
      if @study_session_user.save
        format.html { redirect_to users_tenant_study_session_url(id: @study_session.id, tenant_id: @study_session.tenant_id),
